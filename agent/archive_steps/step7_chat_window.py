...
st.caption("Describe a credit card customer. I will ask for anything missing, then "
...
# ---------------------------------------------------------------------------
typed = st.chat_input("e.g. customer is 39, married with kids, private sector, earns 9000")
